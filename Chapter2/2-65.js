...
function make_tree(entry, left, right) { return list(entry, left, right); }
function list_to_tree(elements) { return head(partial_tree(elements, length(elements))); }
...
display_list(union_set_as_tree(list_to_tree(list(1, 3, 5, 7)),
...
display_list(intersection_set_as_tree(
